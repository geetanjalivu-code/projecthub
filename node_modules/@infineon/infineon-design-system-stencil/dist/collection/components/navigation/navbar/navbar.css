...
.navbar__container {
  ...
  gap: 16px;
  height: var(--navbar-height);
  padding: 0 var(--navbar-inline-padding);
...
.navbar__left--hidden,
.navbar__right--hidden,
.navbar__left--empty {
  display: none;
}

.navbar__left--expanded,
.navbar__right--expanded {
  flex: 1;
  min-width: 0;
  justify-content: initial;
}
.navbar__left--expanded .navbar__search,
.navbar__right--expanded .navbar__search {
  flex: 1;
  width: auto;
}
...
::slotted([slot=left-item]),
::slotted([slot=right-item]) {
  flex: none;
  white-space: nowrap;
}

::slotted([slot=search-bar-left]),
::slotted([slot=search-bar-right]) {
  min-width: 0;
  max-width: 100%;
}
...
.navbar__mobile-nav {
  ...
  padding: 0 var(--space-300, 24px) 30px;
  overflow-y: auto;
}
...
.navbar__sidebar-top-row-item {
  ...
  align-self: stretch;
  padding: var(--space-200, 0) var(--space-50, 4px) var(--space-200, 0) 0;
  cursor: pointer;
}
...
.navbar__sidebar-content-products-header span,
.navbar__sidebar-content-about-header span {
  display: flex;
  align-items: center;
  color: #1d1d1d;
  font-size: 18px;
...
.navbar__sidebar-content-products-menu-item a,
.navbar__sidebar-content-main-menu-item a {
  display: flex;
  align-items: center;
  color: #1d1d1d;
  font-size: 16px;
...
@media screen and (max-width: 800px) {
  ...
  .navbar__container--expanded .navbar__burger {
    display: none;
  }
  .navbar__left {
    display: none;
