...
const IfxIcon = class {
    ...
    getSVG(svgPath) {
        ...
        return (index.h("svg", { class: "inline-svg", width: width, height: height, xmlns: "http://www.w3.org/2000/svg", fill: fill, viewBox: viewBox, focusable: "false", role: "presentation", "aria-hidden": "true" // Label should be set on the ifx-icon element, e.g. <ifx-icon icon="c-check-16" aria-label="Check Icon"></ifx-icon>
        }, ...svgPath));
    }
    constructIcon() {
        if (this.iconSvg) {
    ...
    setIcon() {
        ...
        this.iconSvg = icons.getIcon(iconName);
    }
    isInsideAgGrid(el) {
        let current = el;
        while (current) {
    ...
    render() {
        return index.h(index.Host, { key: '014bbff680dd28a3b3dc8d81a31379e62445b225' }, this.constructIcon());
    }
