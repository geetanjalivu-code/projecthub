...
const Popover = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '64c6043a26ca1cd2bc01bc76bfc23a66d21ba9cd', class: "popover__container", "aria-label": this.ariaLabelText }, index.h("slot", { key: '2da9eb5dbf844c190733e664c76fc1f5b9c1cb44' }), index.h("div", { key: 'e3a90435ad253efd361e7dc9502182f62ca149df', class: popoverClass, role: "dialog", "aria-modal": "false" }, index.h("button", { key: '1b78bcdafeec1fc54a63cb8eeaa9447796263dc4', "aria-label": "Close Popover", class: "popover-close", onClick: this.onCloseClick }, index.h("ifx-icon", { key: 'c8475c7c4201fe353fe159347d4523d3a827ab79', icon: "cross16" })), index.h("div", { key: 'dddf5122f532b93d7b953343be6cc56bbe415cf9', class: "popover-content" }, this.popoverTitle && index.h("div", { key: '900232e5a5c43fb16177e07b0faff6e668600bc1', class: "popover-title" }, this.popoverTitle), this.text && index.h("div", { key: 'ccc6f2a94a526e6d40fc3d41207bb75b41a482a5', class: "popover-text" }, this.text), index.h("slot", { key: '4afd7ab73616462603a1be04646599961c2e7a84', name: "content" })), index.h("svg", { key: 'ab54d636762835f5e698b8bc4ba77b4c3890cde6', class: "popover-arrow-svg", xmlns: "http://www.w3.org/2000/svg", width: "12", height: "8", viewBox: "0 0 12 8", fill: "none", style: arrowStyles }, index.h("path", { key: '0366f9fb0b0cdcd63ae91c602e2d6cbdc546c515', d: "M6 8L0 0L12 0L6 8Z", fill: "currentColor" })))));
    }
