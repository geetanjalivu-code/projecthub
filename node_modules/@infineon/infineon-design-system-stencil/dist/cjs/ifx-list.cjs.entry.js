...
const listCss = () => `.link-wrapper{display:flex;flex-direction:column;align-items:center;gap:8px;margin-top:8px;font-family:var(--ifx-font-family)}`;

const List = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.ifxListUpdate = index.createEvent(this, "ifxListUpdate", 7);
    }
    ...
    renderList() {
        ...
        return (index.h("div", { class: "list-wrapper" }, visibleItems.map((entry) => (index.h("slot", { name: entry.getAttribute("slot") }))), (remainingItems > 0 || this.showMore) && (index.h("div", { class: "link-wrapper", onClick: this.toggleShowMore }, index.h("ifx-icon", { key: this.showMore.toString(), icon: this.showMore ? "chevron-up-16" : "chevron-down-16" }), index.h("ifx-link", { size: "s", href: "", target: "_blank", variant: "underlined", disabled: false }, this.showMore ? "Show less" : `Show ${remainingItems} more`)))));
    }
