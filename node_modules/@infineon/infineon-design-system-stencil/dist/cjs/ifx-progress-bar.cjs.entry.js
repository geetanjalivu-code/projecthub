...
const ProgressBar = class {
    ...
    render() {
        return (index.h("div", { key: '4f549f68f7f72bcecb8dc8357399588cd97cc6a8', role: "progressbar", "aria-valuenow": this.internalValue, "aria-valuemin": "0", "aria-valuemax": "100", "aria-label": `Progress: ${this.internalValue}%`, class: `progress-bar ${this.size}` }, index.h("div", { key: '54125c694cb6c43707094fc1500f3cc6319d9a39', class: "progress", style: { width: `${this.internalValue}%` } }, this.showLabel && this.size !== "s" && this.internalValue !== 0 && (index.h("span", { key: 'bd507fb1449bc353b6b2948508a4909d331c158d', class: "label" }, `${this.internalValue}%`)))));
    }
