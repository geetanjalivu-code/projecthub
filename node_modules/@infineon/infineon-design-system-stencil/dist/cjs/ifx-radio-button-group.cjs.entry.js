...
const RadioButtonGroup = class {
    ...
    render() {
        return (index.h("div", { key: '8a345d3b6e89872b19eef5f5d3f80ece55d0e8d5', class: "radio-button-group-container" }, this.showGroupLabel && (index.h("div", { key: '75a00494eb8dd1ad87166a00d5aade9194f7873d', class: "group-label" }, this.groupLabelText, this.required && (index.h("span", { key: 'f8be77122553dafb2d1d6e8b35d027a81c9fa098', class: `required ${this.hasErrors ? "error" : ""}` }, "*")))), index.h("div", { key: '23d91d53a876b2af915f63cd9080c1eaddd75b56', class: `radio-button-group ${this.alignment} ${this.size}` }, index.h("slot", { key: '5c501ca9b4e1815e4d9a7f9f1c6bef3c72d76e07', onSlotchange: this.handleSlotChange })), this.showCaption ? (index.h("div", { class: `caption ${this.hasErrors ? "error" : "default"}` }, this.showCaptionIcon ? (index.h("div", { class: "caption-icon" }, index.h("ifx-icon", { icon: "c-info-16" }))) : (""), index.h("div", { class: "caption-text" }, this.captionText))) : ("")));
    }
};
