...
const Stepper = class {
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-stepper", await framework);
        }
        this.syncIfxSteps();
    }
    componentWillUpdate() {
    ...
    render() {
        return (index.h("div", { key: '9e75f239aaf64109df1c4faa8f7a0d7d84e9f59c', "aria-label": this.ariaLabelText, "aria-current": this.ariaCurrentText, role: "navigation", class: `stepper ${this.variant !== "compact" && this.variant !== "vertical" ? "default" : this.variant} ${this.variant === "compact" ? "compact-" + this.indicatorPosition : ""}` }, 
        /* Progress bar for compact variant. */
        this.variant === "compact" && (index.h("div", { key: '9ef6ec5638f5624b23b3c7c13310859e323c1ba7', class: "stepper-progress" }, index.h("div", { key: 'a3d761f866facaad4581651b0eed1d06ea93f385', class: "progress-detail" }, `${Math.min(this.activeStep, this.stepsCount)} of ${this.stepsCount}`))), index.h("div", { key: 'd7892a8a22445a24b9f8ac719a2274270f8712c9', class: `stepper-wrapper` }, index.h("slot", { key: 'f67dc55a84db5af1f6a4fc49b29b58117b9d055e' }))));
    }
    componentDidRender() {
