 ...
 */
function applyToastConfig(toast, config) {
    if (config.toastId !== undefined)
        toast.toastId = config.toastId;
    if (config.status !== undefined)
        toast.status = config.status;
    if (config.message !== undefined)
        toast.message = config.message;
    if (config.actionText !== undefined)
        toast.actionText = config.actionText;
    if (config.duration !== undefined)
        toast.duration = config.duration;
}

exports.applyToastConfig = applyToastConfig;
