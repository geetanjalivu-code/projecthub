...
var animation = require('./animation-DvEMST7j.js');
...
const Toast = class {
    constructor(hostRef) {
        ...
        this.ifxToastOpen = index.createEvent(this, "ifxToastOpen", 7);
        this.ifxToastClose = index.createEvent(this, "ifxToastClose", 7);
        this.ifxToastAction = index.createEvent(this, "ifxToastAction", 7);
    }
    ...
    async componentDidLoad() {
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-toast", await framework);
        }
    ...
    runEnterAnimation() {
        ...
        try {
            ...
            const grow = animation.animationTo(host, [
            ...
            animation.animationTo(this.toastEl, FADE_IN, { duration: 250 });
        }
        catch (_err) {
    ...
    emitCloseAfterExit(reason) {
        ...
        try {
            ...
            const collapse = animation.animationTo(host, [
            ...
            animation.animationTo(this.toastEl, FADE_OUT, { duration: 200 });
        }
        catch (_err) {
            emit();
        }
    ...
    renderIcon() {
        if (this.status === "loading") {
            return index.h("ifx-spinner", { variant: "default", size: "s", ariaLabelText: "Loading" });
        }
        return index.h("ifx-icon", { icon: STATUS_ICONS[this.status] });
    }
    render() {
        const isDanger = this.status === "danger";
        return (index.h(index.Host, { key: 'f2fe08bb0583b15f5d8b432772beec156934d977' }, index.h("div", { key: 'db60feb1f48426b4ff3a4b52d7ef0036f21e4da3', ref: (el) => {
                this.toastEl = el;
            }, class: `ifx-toast ifx-toast--${this.status}`, role: isDanger ? "alert" : "status", "aria-live": isDanger ? "assertive" : "polite" }, index.h("div", { key: 'fd234a62c13def95b7b0081c55b521f524df5bb5', class: "ifx-toast__icon" }, this.renderIcon()), index.h("div", { key: 'b6bd829a10f2a10e4ce18cad186fe52b26ff58ce', class: "ifx-toast__body" }, this.message ? this.message : index.h("slot", null)), this.actionText && (index.h("div", { key: 'ba37d5d528f326b01085cb00f05900f5637420bd', class: "ifx-toast__action" }, index.h("button", { key: '542a46c813021a183c943b7acb4d8bc886ec9493', type: "button", onClick: this.handleAction }, this.actionText))))));
    }
