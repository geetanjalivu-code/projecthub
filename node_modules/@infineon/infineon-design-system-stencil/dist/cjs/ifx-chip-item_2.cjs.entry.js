...
const ChipItem = class {
    ...
    render() {
        return (index.h("div", { key: '98f70fa7c8f887a7cb7e8de4fd12ff227caf866d', class: `chip-item chip-item--${this.chipState.size} 
                    chip-item--${(this.selected && this.chipState.variant) === "single" ? "selected" : ""}`, tabIndex: 0, onClick: () => {
                this.handleItemClick();
            }, onKeyDown: (e) => {
                this.handleItemKeyDown(e);
            }, role: "option", "aria-selected": this.selected.toString() }, this.chipState.variant === "multi" && (index.h("ifx-checkbox", { key: '82d51acfb08b5c8a0de145647541bdebc256502b', checked: this.selected, tabIndex: -1, size: "s" })), index.h("div", { key: '6df5d44780fa33c77d8245ab08912b0e81490e40', class: "chip-item__label" }, " ", index.h("slot", { key: '544d259a6d34ac8867d666cc2f2602e78a1dc92d' }), " "), index.h("div", { key: 'd2e58d827f5b5ceb039a590984f4e4ada1fd8f47', class: "chip-item__selected-indicator" }, index.h("ifx-icon", { key: 'b9c01acc2a91921482a51e02c894dba8b8876520', icon: "check-16" }, " "))));
    }
...
const Pagination = class {
    ...
    async componentDidLoad() {
        ...
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-pagination", await framework);
        }
        this.initPagination();
    }
    ...
    render() {
        return (index.h("div", { key: 'ced6da15f31395d69b3169ecaa7a32e39c682730', class: "container" }, this.showItemsPerPage && (index.h("div", { key: 'e7717af2e645fb15bdfdcf76b565aa1ab078d29f', class: "items__per-page-wrapper" }, index.h("div", { key: '0b52a412f2055a6653f0dafa752736dff0918ea9', class: "items__per-page-label" }, this.itemsPerPageLabel), index.h("div", { key: '2ca0cb6101368429676ffa91b8f4b6b261d84d44', class: "items__per-page-field" }, index.h("ifx-select", { key: '43f634af317bb1413895d5db9920500782c89ac3', id: "itemsPerPageSelect", placeholder: "false", "show-search": "false", value: undefined, disabled: false, error: false, size: "s", options: this.filteredItemsPerPage, "placeholder-value": "Select" })))), index.h("div", { key: 'dc1ea5ba547be98552a28d136d561c7b160e69f5', class: "items__total-wrapper" }, index.h("div", { key: '662b10ca258f55153b27a3b45cb0c30b9f1d0bca', class: "pagination" }, index.h("ifx-icon-button", { key: '1b9cff292a65ad537b8b52f6a45b7fd13abbdb4f', class: "prev", icon: "arrow-left-16", "aria-label": "Previous Page", onClick: () => this.changePage(this.internalPage - 1), variant: "secondary" }), index.h("ol", { key: 'b8363c54b7148d9759724c652773406dc9559c66' }, this.visiblePages.map((page, i) => typeof page === "number" ? (index.h("li", { key: `page-${page}`, class: { [this.CLASS_ACTIVE]: page === this.internalPage }, "data-page": page }, index.h("span", { class: "page__button", role: "button", tabindex: "0", "aria-current": page === this.internalPage ? "page" : undefined, "aria-label": `Page ${page}`, onClick: () => this.changePage(page), onKeyDown: (e) => (e.key === "Enter" || e.key === " ") &&
                this.changePage(page) }, page))) : (index.h("li", { class: "ellipsis", key: `ellipsis-${i}` }, index.h("span", { "aria-hidden": "true" }, "..."))))), index.h("ifx-icon-button", { key: 'a4e2b39ab6567d68d8384531393665b0b7c107ad', class: "next", icon: "arrow-right-16", "aria-label": "Next Page", onClick: () => this.changePage(this.internalPage + 1), variant: "secondary" })))));
    }
    static get watchers() { return {
        "total": [{
                "watchTotalHandler": 0
