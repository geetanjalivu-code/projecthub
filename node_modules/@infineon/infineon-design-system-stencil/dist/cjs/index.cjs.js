...
function createHandle(el) {
    return {
        el,
        update(options) {
            toastConfig.applyToastConfig(el, options);
        },
        dismiss() {
            dismissToast(el);
        },
