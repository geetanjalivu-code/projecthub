...
const FilterSearch = class {
    constructor(hostRef) {
        ...
        this.ifxFilterSearchChange = index.createEvent(this, "ifxFilterSearchChange", 7);
    }
    ...
    render() {
        return (index.h("div", { key: 'c662c2fb4393a503219bceb20f586b83e6774fd5', class: `${this.filterOrientation === "sidebar"
                ? "sidebar-filter-search-wrapper"
                : "topbar-filter-search-wrapper"}` }, index.h("div", { key: 'c1cd5ed550b9c26eee4c9f923ac86a0cab6778ee', class: "filter-name" }, this.filterName), index.h("ifx-search-field", { key: '6ec629cfdf229dcee96aebe62b6e1be8a6f152de', placeholder: this.placeholder, "show-delete-icon": this.showDeleteIcon, disabled: this.disabled, value: this.filterValue })));
    }
...
exports.ifx_filter_search = FilterSearch;
