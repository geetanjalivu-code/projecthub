...
const ActionListItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '443e561a3a30f25d2b9a21f47ed2e0b7eac894a9', class: index$1.classNames("action-list-item", this.disabled && "action-list-item--disabled", isClickable && "action-list-item--clickable"), role: "listitem", tabIndex: isClickable ? 0 : -1, "aria-label": ariaLabel, "aria-disabled": this.disabled ? "true" : undefined, onClick: this.handleMainClick, onKeyDown: this.handleMainKeyDown }, hasLeadingContent && (index.h("div", { key: 'b297863d7fe76fd8682e18f299b1c49cdf5b82a4', class: "action-list-item__leading", onClick: this.handleLeadingClick, onKeyDown: this.handleLeadingKeyDown }, index.h("slot", { key: '0f65e4f44b14c138e0d234104d8175a0acfe9cc0', name: "leading" }))), index.h("div", { key: '1d324432cfc595f4bfbe30dcbf26f240c40a3e89', class: "action-list-item__content" }, index.h("div", { key: '9473e08be2b90322f3aa8759356b8c964da3e435', class: "action-list-item__title" }, this.itemTitle), this.description && (index.h("div", { key: '926cf7b7e8a6a1afb214139eba706b967ef9932b', class: "action-list-item__description" }, this.description))), hasTrailingContent && (index.h("div", { key: '0b5d67c6e09d74b21b0b831746aae4e12ee8a6c6', class: "action-list-item__trailing", onClick: this.handleTrailingClick, onKeyDown: this.handleTrailingKeyDown }, index.h("slot", { key: '8b0dd89f53cec9a72e0486d5d2c534f88d24b79a', name: "trailing" })))));
    }
