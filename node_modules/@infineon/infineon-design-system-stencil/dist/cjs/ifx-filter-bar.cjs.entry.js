...
const FilterBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5d3efa02340cc564eb7f492d2f6983ebdfaa3af2' }, index.h("div", { key: '09d40ba763a74c3b24b48e5ba8be364536cb42fe', class: "search-container" }, index.h("slot", { key: 'c1bb9904095ca5029ee6e588211cd40866ba638e', name: "filter-search" }), " "), index.h("div", { key: '95701282f7f6b59dec9a963c883b28fab6fa2a4c', class: "components-container" }, slots.length > 0 ? slots : index.h("slot", { name: "filter-component" }), this.showMoreFilters && (index.h("div", { key: 'e214b5792fac0273d9fbc5b92bb45f2139b00cd4', class: "filter-buttons-wrapper", onClick: () => this.handleFilterButtonsClick(!this.showAllFilters) }, index.h("ifx-button", { key: '07c585bf40c9737b574c661f2a5f528a228f0cfd', type: "button", disabled: false, variant: "tertiary", size: "m", target: "_blank", theme: "default", "full-width": "false" }, index.h("ifx-icon", { key: '244c4341da6325d23873541099f51e293ec89005', icon: "filter-16" }), this.showAllFilters ? "Less filters" : "More filters"))))));
    }
};
