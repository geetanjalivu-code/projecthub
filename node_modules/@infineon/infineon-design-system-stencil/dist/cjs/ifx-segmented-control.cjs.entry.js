...
const SegmentedControl = class {
    ...
    render() {
        return (index.h("div", { key: 'f6a1e42cb8304ec91233cb25791277601febb475', "aria-value": this.selectedValue, "aria-label": "segmented control", class: "group" }, index.h("div", { key: '090d774735fc6dd8ea052e705ac78a3003c50f67', class: "group__label" }, this.label.trim(), this.required && this.label.trim().toLowerCase() !== "" && (index.h("span", { key: '55659b78081b6198b2adf2c0ee7557511d672065', class: `required ${this.error ? "error" : ""}` }, "*"))), index.h("div", { key: '853dc038c485d65357b4238ab39e3ffae77e5fad', class: "group__controls" }, index.h("slot", { key: '28af28c0504d08feca70aeda120660f06086c111' })), this.caption.trim() && (index.h("div", { key: '0b9f8abc5a976b8493038fdca0c0aa4f8caa9996', class: `group__caption ${this.error ? "error" : ""}` }, index.h("ifx-icon", { key: '6af52438df40a87fd1ae7b90bff336718124e094', icon: "c-info-16" }), " ", this.caption.trim()))));
    }
    componentDidRender() {
        this.setSegmentSize();
    }
