...
const SidebarItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '01bc15fbde4d9a0f5b0f10886b9e5a0c95ef4534', style: { display: shouldHide ? "none" : "block" } }, index.h("a", { key: 'f1ea941ddb78826e1f8c7a70b00f236d1a782baa', tabIndex: 1, onKeyDown: (event) => this.handleKeyDown(event), href: this.internalHref, onClick: () => this.toggleSubmenu(), target: this.target, class: `sidebar__nav-item ${!this.isNested && this.isExpandable ? "header__section" : ""} ${this.isSubMenuItem ? "submenu__item" : ""}`, title: this.titleText }, this.icon && (index.h("div", { key: 'f1b222a55676446ac807bcd6a369da81ffcd2d8f', class: `sidebar__nav-item-icon-wrapper ${!this.showIcon && !isCollapsed ? "noIcon" : ""}` }, index.h("ifx-icon", { key: '2143897828ff7426c77c05f58fbce0974901ed46', icon: this.icon }))), index.h("div", { key: '760e81468fad1754764b91510fece92ca9a3ac04', class: "sidebar__nav-item-label" }, index.h("slot", { key: '48bca1069d546822e69297c58fa13bf3118ce20c' })), (this.isExpandable || !isNaN(this.numberIndicator)) && (index.h("div", { key: 'b4139040e850bbfe0a57effc3ce320b47c4990b5', class: "sidebar__nav-item-indicator", style: {
                display: !isCollapsed || this.icon ? "flex" : "none",
            } }, this.isExpandable && (index.h("span", { key: '9ed5433215ecf3850f8f9a3f0cc19acac3fe0edd', class: "item__arrow-wrapper" }, index.h("ifx-icon", { key: 'f820af10654210d0d05e6a8cb071718a61051744', icon: "chevron-down-16" }))), this.numberIndicator > 0 &&
            !this.isExpandable &&
            !this.isNested && (index.h("span", { key: '2f474192db483732c6313652835ee9cc21624dd6', class: "item__number-indicator" }, index.h("ifx-indicator", { key: 'f2122662bda37e86dd9d21ff316f7a9a6ecab0c6', variant: this.indicatorVariant, number: this.numberIndicator })))))), this.isExpandable && index.h("ul", { key: 'b257d0d6d358f9a0698a1e56401d43c062e12db9', class: "expandable__submenu" })));
    }
