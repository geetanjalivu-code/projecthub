...
const DropdownItem = class {
    ...
    render() {
        ...
        const common = {
            ...
            onClick: (e) => this.handleEventEmission(e),
            role: "menuitem",
        ...
        const content = [
            this.icon && index.h("ifx-icon", { key: 'd7b967e5900d929cee06ac3a89828bc6e5efe073', class: "icon", icon: this.icon }),
            index.h("span", { key: '16084374bcb36a4c8547a02398fd48ceba1b8a38' }, index.h("slot", { key: '285646d921ae3799cb318b8e7daad3a68f15e7f0' })),
        ];
        return hasHref ? (index.h("a", { ...common, href: this.href, target: this.target }, content)) : (index.h("button", { ...common, type: "button", disabled: this.disabled }, content));
    }
};
