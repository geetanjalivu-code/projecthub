...
const Switch = class {
    ...
    async componentDidLoad() {
        ...
        if (!domUtils.isNestedInIfxComponent(this.el)) {
            ...
            tracking.trackComponent("ifx-switch", await framework);
        }
        this.toggleLabelGap();
    }
    /**
    ...
    render() {
        return (index.h("div", { key: '39c4788efc17dd31b6801bf606bbe00a9361f30f', class: "container", role: "switch", "aria-checked": this.checked ? "true" : "false", "aria-disabled": this.disabled || this.readOnly ? "true" : "false", "aria-readonly": this.readOnly ? "true" : "false", "aria-labelledby": "switch-label", tabIndex: this.disabled ? -1 : 0, onClick: () => this.toggleSwitch(), onKeyDown: (event) => this.handleKeyDown(event) }, index.h("div", { key: '4b1d2bbca2170d7e827e29f3385041664b3a5085', class: `switch__checkbox-container ${this.checked ? "checked" : ""} ${this.readOnly ? "readOnly" : this.disabled ? "disabled" : ""}` }, index.h("div", { key: '0fcfa646397a57052821af040dcbcb07a688163d', class: "switch__checkbox-wrapper" }, index.h("input", { key: '59faa434bb744036a21083e7cd1a42e022b2f8f4', type: "checkbox", hidden: true, name: this.name, disabled: this.disabled && !this.readOnly, checked: this.checked, value: this.value }), index.h("div", { key: 'cc0bdba1276e80ff009efe7571d609f95e263f82', class: `switch ${this.checked ? "checked" : ""} ${this.readOnly ? "readOnly" : this.disabled ? "disabled" : ""}` }))), index.h("div", { key: '41416a8a4f35513b3f8b24149acc2b1540b79374', class: `switch__label-wrapper ${this.readOnly ? "readOnly" : this.disabled ? "disabled" : ""}` }, index.h("label", { key: 'd5328bb9cb83843f2482e49bc141f5b051f2b8d6', htmlFor: "switch" }, index.h("slot", { key: 'bcfe25923e7b7b4fbc3c49af88ae63a4a33980c4', onSlotchange: () => this.toggleLabelGap() })))));
    }
