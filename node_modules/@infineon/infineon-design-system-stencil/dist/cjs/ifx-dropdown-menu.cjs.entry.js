...
const DropdownMenu = class {
    ...
    render() {
        return (index.h("div", { key: 'c70f8a8e5387163e6d4a5c87b30fa40fbc8abd4e', class: `dropdown-menu 
      ${this.isOpen ? "show" : ""} 
      ${this.hideTopPadding ? "hideTopPadding" : ""}
      ${this.size === "s" ? "small" : ""}` }, index.h("slot", { key: '13438579438db1f5cefc95803d8ea9789e552b02' })));
    }
};
