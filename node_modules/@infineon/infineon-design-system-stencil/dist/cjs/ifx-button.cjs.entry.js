...
const Button = class {
    ...
    render() {
        return (index.h(index.Host, { key: '225baabfc86624de623ef2a9e1bd9b68136060bd' }, index.h("a", { key: 'd735b85f4d47274727d7c017c442093e9145e160', role: this.href ? "link" : "button", tabIndex: this.disabled ? -1 : 0, ref: (el) => (this.focusableElement = el), class: this.getClassNames(), href: !this.disabled ? this.internalHref : undefined, target: this.target, onClick: this.handleClick, rel: this.target === "_blank" ? "noopener noreferrer" : undefined, onFocus: (event) => this.handleFocus(event), "aria-disabled": this.disabled ? "true" : null, "aria-describedby": this.theme === "danger" ? "Dangerous action" : undefined, "aria-label": this.ariaLabelText || undefined }, index.h("slot", { key: 'f6f8731fcd363a7e76be2f875c0e29144b1f9f60' }))));
    }
    getVariantClass() {
