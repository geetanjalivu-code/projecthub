...
const Sidebar = class {
    constructor(hostRef) {
        ...
        this.ifxSidebarCollapseChange = index.createEvent(this, "ifxSidebarCollapseChange", 7);
        this.ifxSidebarLogoClick = index.createEvent(this, "ifxSidebarLogoClick", 7);
    }
    ...
    isSidebarItem(element) {
        return (typeof element.isItemExpandable ===
            "function");
    }
    async componentDidLoad() {
        const framework = tracking.detectFramework();
        tracking.trackComponent("ifx-sidebar", await framework);
