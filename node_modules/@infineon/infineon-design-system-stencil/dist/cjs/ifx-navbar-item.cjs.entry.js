...
const NavbarItem = class {
    ...
    render() {
        return (index.h("div", { key: 'c60d6fabe45704b913a0836327fc17e813dd0576', tabIndex: 1, class: "container", onMouseLeave: (e) => this.handleNestedLayerMenu(e), onKeyDown: (e) => this.handleKeyDown(e), onMouseEnter: (e) => this.handleNestedLayerMenu(e) }, index.h("div", { key: '19d9cea683032d2be10a69fc4e3c277f2d0cbe76', class: "sub__layer-back-button" }, index.h("div", { key: '55c22a036e3583d995b944e811f1f034111c4fdd', class: "back__button-wrapper", onClick: () => this.returnToFirstLayer() }, index.h("ifx-icon", { key: '1c9ddac500ec9d35b6e6eaee2270a316e2355a22', icon: "arrow-left-16" }), index.h("span", { key: '3079e333acae8b95a37565630819992ee48bd86a' }, "Back"))), index.h("a", { key: '9cc5b58771722a606546078f4421aadf3abfd12f', tabindex: -1, href: this.internalHref, target: this.target, onClick: () => this.toggleItemMenu(), class: `navbar__item ${this.isSidebarMenuItem ? "sidebarMenuItem" : ""} ${!this.showLabel ? "removeLabel" : ""} ${this.isMenuItem ? "menuItem" : ""} ${this.hasChildNavItems ? "isParent" : ""}` }, index.h("div", { key: 'b2c6bcdb46553ae0f143dae58d9478c148465b4f', class: "inner__content-wrapper" }, index.h("div", { key: '64d776e19812da72f6fb7e9b0d5c238a3d1fd1f6', class: `navbar__container-right-content-navigation-item-icon-wrapper ${!this.icon ? "removeWrapper" : ""}` }, this.icon && index.h("ifx-icon", { key: 'cbca9c8f83b10889f26d706a0e8d34bc55fa7a41', icon: this.icon }), this.icon && !this.showLabel && !isNaN(this.numberIndicator) && (index.h("div", { key: '10190e24503a54d40c5d943fdc4840da4f7d0f06', class: "number__indicator-wrapper" }, index.h("ifx-indicator", { key: '945fb452e1819723bca0e03f233660a1a0931e56', variant: "number", number: this.numberIndicator }))), this.icon &&
            !this.showLabel &&
            !this.numberIndicator &&
            this.dotIndicator && index.h("div", { key: 'd0af5667570ac85eb08c34f2735e5b2318a67a82', class: "dot__indicator-wrapper" })), this.itemPosition === "left" &&
            this.hasChildNavItems &&
            this.isMenuItem && (index.h("div", { key: '3023ceba678937ee40749a1d58a6a65626754f3e', class: "menuItemLeftIconWrapper" }, index.h("ifx-icon", { key: '180f1b471f9ed5da8e6b7a0de75de81932330a20', icon: "chevron-left-16" }))), index.h("span", { key: '5ad988c4cf957df63029b5e1b0d5e9df318c2092', class: "label__wrapper" }, index.h("slot", { key: 'cded95e195418aba64e30b4b48241d76b60a3f2c' }))), this.showLabel &&
            this.numberIndicator &&
            !isNaN(this.numberIndicator) ? (index.h("div", { class: "number__indicator-wrapper" }, index.h("ifx-indicator", { variant: "number", number: this.numberIndicator }))) : (""), this.showLabel && !this.numberIndicator && this.dotIndicator ? (index.h("ifx-indicator", { variant: "dot" })) : (""), index.h("div", { key: 'f582722dd761ae0c4c5f14a7ad95d1264ce79cae', class: `navItemIconWrapper ${this.hasChildNavItems && !this.isMenuItem && !this.isSidebarMenuItem ? "" : "hide"}` }, index.h("ifx-icon", { key: 'ab8dc8afbfcb25d2afd31fabb5e5dda4adc7747c', icon: "chevron-down-16" })), index.h("div", { key: 'd6e8c6995aadbd18577fe3d9b513a4a765efa70d', class: `menuItemRightIconWrapper ${(this.itemPosition === "right" && this.hasChildNavItems && this.isMenuItem) || (this.isSidebarMenuItem && this.hasChildNavItems) ? "" : "hide"}` }, index.h("ifx-icon", { key: '8665a8c85b6c69f89147720b7b552d370b4506de', icon: "chevron-right-16" }))), this.hasChildNavItems && !this.isSidebarMenuItem && (index.h("ul", { key: '701a1bd12c0d19b019a7379ff1a2743044b87c13', class: "navbar-menu" }, " ", index.h("slot", { key: '48ef7bedfa26f1d2d64811ea13f20df61ecdf4bf', name: "first__layer" }), " ")), this.isSidebarMenuItem && (index.h("ul", { key: 'fc464c7924f2aeefdb77b074e12ceef51973ed49', class: "sub__layer-menu" }, " ", index.h("slot", { key: '1701cadf66169ac70c3da6c4a0248f1018a410c3', name: "second__layer" }), " "))));
    }
};
