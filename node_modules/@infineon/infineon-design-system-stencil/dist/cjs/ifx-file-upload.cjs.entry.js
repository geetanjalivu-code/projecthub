...
const FileUpload = class {
    ...
    render() {
        return (index.h("div", { key: '0ca756ca7c6ce17db7ce906f0b75c29ce4476439', class: {
                "file-upload-wrapper": true,
                disabled: this.disabled,
            } }, this.label && (index.h("label", { key: '706c98387f66ce6aebd544a89f9242ba5b882d65', class: "file-upload-label", htmlFor: this.internalId }, this.label, this.required && (index.h("span", { key: 'c5867366fa86106d2d8928619eef55daa8265ca6', class: `required ${this.requiredError ? "error" : ""}` }, "*")))), this.dragAndDrop
            ? this.renderDragAndDropArea()
            : this.renderUploadArea(), (this.files.length > 0 ||
            this.rejectedSizeFiles.length > 0 ||
            this.rejectedTypeFiles.length > 0) && (index.h("div", { key: '0ad3d5f6674b890cedc641e47e0d58eb55d119b0', class: "file-list-wrapper" }, index.h("div", { key: 'dddb73bbcdfa6b68fdf2a1e71b2360ecae4d683c', class: "upload-heading" }, this.labelUploadedFilesHeading), index.h("ul", { key: '0811e3dd0dd7fdce2a28860b69c27f7f0bd90a6a', class: "file-list" }, this.rejectedSizeFiles.map((fileName) => (index.h("li", { class: "file-item upload-failed", key: `rejected-size-${fileName}` }, index.h("div", { class: "file-icon" }, index.h("ifx-icon", { icon: "file-16" })), index.h("div", { class: "file-info" }, index.h("div", { class: "file-top-row" }, index.h("span", { class: "file-name-wrapper" }, index.h("span", { class: "file-name-base" }, this.splitFileNameParts({ name: fileName })
