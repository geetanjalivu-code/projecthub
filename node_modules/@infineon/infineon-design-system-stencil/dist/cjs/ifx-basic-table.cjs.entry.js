...
const Table = class {
    ...
    componentWillLoad() {
        ...
        main_esm.provideGlobalGridOptions({ theme: "legacy" });
    ...
    async componentDidLoad() {
        if (this.container && !this.gridInitialized) {
            if (!domUtils.isNestedInIfxComponent(this.host)) {
                ...
                tracking.trackComponent("ifx-basic-table", await framework);
            }
    ...
    render() {
        return (index.h(index.Host, { key: '04983eae3d715212495f539df9a9837bbc7f8ee0' }, index.h("div", { key: '79b911fdf1c4d42abfdc349bbdc92facbf2ab354', id: "table-wrapper", class: this.getClassNames() }, index.h("div", { key: '6e375d572dbf80e5e81d20f48870da567009f751', id: `ifxTable-${this.uniqueKey}`, class: `ifx-ag-grid ${this.variant === "zebra" ? "zebra" : ""}`, style: this.getTableStyle(), ref: (el) => (this.container = el) }))));
    }
};
Table.style = tableCss();

exports.ifx_basic_table = Table;
