...
const BreadcrumbItem = class {
    ...
    render() {
        return (index.h("li", { key: 'e9bb696914257d18fbc9e9b15b3b0a5ec89298d2', class: "breadcrumb-parent", "aria-current": `${this.isLastItem ? "page" : ""}` }, index.h("li", { key: 'ebaea61fbcf7298121d600c5b3972c23a27687d5', role: "button", tabindex: this.hasDropdownMenu ? 0 : -1, class: "breadcrumb-wrapper", onClick: () => this.toggleDropdownMenu(), "aria-controls": this.uniqueId, "aria-haspopup": "menu", "aria-label": "Toggle dropdown menu" }, index.h("slot", { key: 'f7fb36c8c807d897eb92f60b453829d3a8a110fb', name: "label" }), index.h("div", { key: '11724effddd116b2dc564cdc8c7c772c49480c46', id: this.uniqueId, class: "dropdown-menu", "aria-expanded": this.isDropdownMenuOpen(), "aria-label": "Dropdown menu" }, index.h("slot", { key: 'fde70bc16a483db4382f01879a444630eeada4cb' }))), !this.isLastItem && (index.h("span", { key: 'e3a7303b7e7ea688e7e77ff6a00d703d7c78930f', class: "breadcrumb-divider", "aria-hidden": "true" }, "/"))));
    }
};
