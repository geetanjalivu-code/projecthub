...
import { M as ModuleRegistry, A as AllCommunityModule, c as createGrid } from './main.esm-ByHlxOiP.js';
...
const Table = class {
    constructor(hostRef) {
        ...
        this.ifxSortChange = createEvent(this, "ifxSortChange", 7);
    }
    gridOptions;
    gridApi;
    currentPage = 1;
    ...
    render() {
        ...
        const filterClass = this.filterOrientation === "topbar"
            ...
            : this.filterOrientation === "none"
                ? ""
                : "sidebar-layout";
        return (h(Host, { key: '3a8ab1652c319c8a56cd81a146df28ffda9eab13' }, h("div", { key: '456a301348bf3b9ca59f976a8456b2ba4c9c947f', class: "table-container" }, this.filterOrientation === "sidebar" && (h("div", { key: 'fc405f0d813729b4c5a2eb3242de44c006a853a5', class: "sidebar-btn" }, h("ifx-button", { key: '5e7aade25540a08c60f853ccf4f83412a892d5c3', type: "button", disabled: false, variant: "secondary", size: "m", target: "_blank", theme: "default", "full-width": "false", onClick: () => this.toggleSidebarFilters() }, h("ifx-icon", { key: '235569024bc4f3afc7b5c6da05418e57b82bdee8', icon: "cross-16" }), this.showSidebarFilters ? "Hide Filters" : "Show Filters"))), h("div", { key: '5bb2812f396c9f2facb827ddb3a9fbd783d600d4', class: filterClass }, this.filterOrientation === "sidebar" &&
            this.showSidebarFilters && (h("div", { key: '0b160872ed974312f30e3af324405d60ad2c7e8b', class: "sidebar-container" }, h("div", { key: '6950a06d18004dfaed78d1171da67ac43a15008d', class: "filters-title-container" }, h("span", { key: 'dc165b5f27032788c38ec26a41a9c2121b8c4514', class: "filters-title" }, "Filters")), h("div", { key: 'aeedf79f6c3a5eea094e547a7728182a9868bf8b', class: "set-filter-wrapper-sidebar" }, (this.filterOrientation !== "sidebar" ||
            this.showSidebarFilters) && (h("slot", { key: '1c6b82bcebf285f3c0ef1f1fba4216170659e57e', name: "sidebar-filter" }))))), this.filterOrientation !== "none" &&
            this.filterOrientation !== "sidebar" && (h("div", { key: 'e66c13a7ae2f024c8e02e3ea51c1ba69dc7a2431', class: "set-filter-wrapper-topbar" }, (this.filterOrientation !== "sidebar" ||
            this.showSidebarFilters) && (h("slot", { key: '997998439fa5f022f9702c6a03543d4c2d0869be', name: "topbar-filter" })))), h("div", { key: '5111542f2d38f0fd8622258d2aa739c1660b6d00', class: "table-pagination-wrapper" }, this.filterOrientation !== "none" &&
            this.filterOrientation !== "topbar" &&
            this.showSidebarFilters && (h("div", { key: 'f6ef3556d32b464deca7f0659739e6edbc2d869a', class: "filter-chips" }, Object.keys(this.currentFilters).map((name) => {
        ...
        }))), h("div", { key: '39cc9f93a4e436085eb73a7c9e99f219e96ec70d', class: "headline-wrapper" }, this.headline && (h("div", { key: '1d0addb8e616b4e5c427833d5d0910de3838ffef', class: "matching-results-container" }, h("span", { key: '9b333c607fc31c552a290d686001b132448d13cb', class: "matching-results-text" }, this.headline), h("span", { key: '4a34f32cde3c87caedcf4f34ad0ed2ee4dc8fcc8', class: "matching-results-count" }, !this.headlineNumber ? `(${this.matchingResultsCount})` : `(${this.headlineNumber})`), h("div", { key: 'b0085a3a15674b6950393483f6a190be434d4a3a', class: "inner-buttons-left-wrapper" }, h("slot", { key: '504851bc4f493eb00eec0385eb718bd282e46704', name: "inner-button-left" })))), h("div", { key: '963cc6753b7f12f9f1e0803dc4efe60f3413d171', class: "inner-buttons-wrapper" }, h("slot", { key: '03ae071443a1c8cf12bd63e0f1a13c55ccb27142', name: "inner-button-right" }))), h("div", { key: '1caee99aeb4fadfb2d385c8fa786db7df41288b7', id: "table-wrapper", class: this.getTableClassNames() }, h("div", { key: '9a540f6aca6f07d422aaf26bb114286cb4432f73', id: `ifxTable-${this.uniqueKey}`, class: `ifx-ag-grid ${this.variant === "zebra" ? "zebra" : ""}`, style: style, ref: (el) => (this.container = el) })), h("div", { key: 'fd53a1afe50d0dc9b5858de81cab658af52f7b70', class: "pagination-wrapper" }, this.pagination ? (h("ifx-pagination", { total: this.serverSidePagination
