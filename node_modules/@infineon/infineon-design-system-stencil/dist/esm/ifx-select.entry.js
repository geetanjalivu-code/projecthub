...
var ChoicesJs = /*@__PURE__*/getDefaultExportFromCjs(choicesExports);
...
const Choices = class {
    ...
    render() {
        ...
        this.destroy();
        return (h("div", { key: '03659704f5dcb5b4c2504c08b139dde091a4517f', class: `ifx-select-container ${this.readOnly ? 'readOnly' : ''}` }, this.label ? (h("div", { class: `ifx-label-wrapper ${this.readOnly ? '' : this.disabled && !this.error ? 'disabled' : ""}` }, h("span", null, this.label), this.required && h("span", { class: `required ${!this.readOnly && this.error ? 'error' : ''}` }, "*"))) : null, h("div", { key: '60382798284d4ff0ea209cb4bb7e37d40971ca78', class: `${choicesWrapperClass} 
            ${this.readOnly ? 'readOnly' : this.error ? 'error' : this.disabled ? 'disabled' : ''}`, onClick: this.readOnly || (this.disabled && !this.error) ? undefined : e => this.handleWrapperClick(e), onKeyDown: event => this.handleKeyDown(event) }, h("select", { key: '3fb94fabf5ab2dfb83b410c0b1bcd43e8a41796c', class: "single__select-input-field", disabled: this.readOnly || (this.disabled && !this.error), ...attributes, "data-trigger": true }, this.createSelectOptions(this.options)), h("div", { key: '3e666806126693f34f186aebdd4444ede9d8360c', class: "single__select-icon-container" }, this.optionIsSelected && (h("div", { key: '50cd2c73b537b4bf9f128b0c7b5c61b140e112ad', class: `ifx-choices__icon-wrapper-delete ${!this.showClearButton ? 'hide' : ''}` }, h("ifx-icon", { key: 'aef35c89567cb5868d3f8443aa01f541d963dcb8', icon: "cRemove16", onClick: () => this.clearSelection() }))), h("div", { key: '4e9615328ff3f9e1c890f8c0fba6bc408975c313', class: "ifx-choices__icon-wrapper-up" }, h("ifx-icon", { key: "icon-up", icon: "chevron-up-16" })), h("div", { key: '823faa7500550c42ddef8d2c2370c3336da6f596', class: "ifx-choices__icon-wrapper-down" }, h("ifx-icon", { key: "icon-down", icon: "chevron-down-16" })))), this.caption && h("div", { key: 'e8a2a95ad84e47ebfe3cd0d047f97f23860f3b2d', class: `single__select-caption ${this.readOnly ? '' : this.error ? 'error' : this.disabled ? 'disabled' : ''}` }, this.caption)));
    }
    toggleDropdown() {
