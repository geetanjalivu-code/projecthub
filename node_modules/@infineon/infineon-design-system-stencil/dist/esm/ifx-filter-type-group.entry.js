...
const filterTypeGroupCss = () => `:host{display:flex;font-family:var(--ifx-font-family)}.filter-type-group{width:260px;align-items:flex-start;gap:8px}.filter-type-group>::slotted(*){margin-bottom:8px}`;
...
const IfxFilterTypeGroup = class {
  ...
  connectedCallback ensures that the event listeners are properly set up again */
    ...
    render() {
        return (h(Host, { key: '743ff7eb49e1672bf70860921a5bbe16cdd1dede' }, h("div", { key: '56e5c5ea3aa77ad8d0380ec76d2930b515a73772', class: "filter-type-group" }, h("slot", { key: 'ee4ff76ef9d523053b0509c342f724eca063f84e', name: "filter-search" }), h("slot", { key: '64080bbcb8c636301a22f09840adba1ebd9f8fce', name: "filter-accordion" }))));
    }
};
