...
<path fill-rule="evenodd" clip-rule="evenodd" d="M24 14C21.7909 14 20 15.7909 20 18C20 20.2091 21.7909 22 24 22C26.2091 22 28 20.2091 28 18C28 15.7909 26.2091 14 24 14ZM18 18C18 14.6863 20.6863 12 24 12C27.3137 12 30 14.6863 30 18C30 21.3137 27.3137 24 24 24C20.6863 24 18 21.3137 18 18ZM16.5869 28.3984C18.2683 27.0179 20.7466 26 24 26C27.2541 26 29.7324 27.0209 31.4134 28.4024C33.0562 29.7526 34 31.5119 34 33V35C34 35.5523 33.5523 36 33 36H15C14.4477 36 14 35.5523 14 35V33C14 31.5074 14.9433 29.7479 16.5869 28.3984ZM17.8561 29.9441C16.5187 31.0421 16 32.2826 16 33V34H32V33C32 32.2881 31.4818 31.0474 30.1436 29.9476C28.8436 28.8791 26.8219 28 24 28C21.1774 28 19.1557 28.8771 17.8561 29.9441Z" fill="white"/>
    ...
    render() {
        return (h("div", { key: '3ace55373eb086d410246d7d9fe82f3acd3e2151', class: "container" }, h("a", { key: 'c5f0e5e3df5a0ef2d10f4e246a8bdc8e7f92d336', href: this.internalHref, target: this.target, onClick: () => this.toggleItemMenu(), class: `navbar__item ${!this.showLabel ? "removeLabel" : ""} ${this.hasChildNavItems ? "isParent" : ""}` }, h("div", { key: '096270aa132c238869f98431624a9aa08fdae75f', class: "inner__content-wrapper" }, h("div", { key: 'c073c8f07728aa67346d33e8362d8c539e15390f', class: `navbar__container-right-content-navigation-item-icon-wrapper` }, this.userName.trim() !== "" && (h("div", { key: '78376c4c5a04f85ec8df5eaba93a0b933bb0c7d9', class: "username__tooltip" }, this.userName)), this.internalImageUrl.type !== "initials" && (h("img", { key: 'ad776c85356daaa525f734eff14108ca9012eb02', src: this.internalImageUrl.type === "url"
                ? this.internalImageUrl.value
                : `data:image/svg+xml,${encodeURIComponent(this.defaultProfileImage)}`, alt: this.alt })), this.internalImageUrl.type === "initials" && (h("div", { key: '52e1f1bbaa6075dd8fcecfd3a88f61af39221d24', class: "initials__wrapper" }, h("span", { key: '6d24e033b7cfe935a7a1158e5c78795a5e0518b2', class: "initials" }, this.internalImageUrl.value)))), h("span", { key: '5df468f490ee9218a119aaa2ee668bf976f2107f', class: "label__wrapper" }, h("slot", { key: '8cb69f4edff6c6f24ca0493850498cc597665f54', onSlotchange: () => this.setProfileGap() })))), this.hasChildNavItems && (h("ul", { key: '4bb87c39554512ec23161383ed40c0becb0d145a', class: "navbar-menu rightSideItemMenu" }, " ", h("slot", { key: '646477874a2a5bceb77d5ce38bf56aea4cab34a0', name: "first__layer" }), " "))));
    }
