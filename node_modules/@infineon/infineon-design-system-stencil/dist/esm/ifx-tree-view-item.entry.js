import { r as registerInstance, c as createEvent, a as getElement, h, F as Fragment } from './index-Cc7fFwRM.js';
...
const TreeViewItem = class {
    ...
    render() {
        return (h("div", { key: '426c7d5b94f0b23ffb904bdc2d140ee6f55c588b', class: {
                "tree-item": true,
                "tree-item--expanded": this.isExpanded,
                "tree-item--has-children": this.hasChildren,
                "tree-item--disabled": this.disabled,
            }, role: "treeitem", "aria-expanded": this.isExpanded ? "true" : "false", "data-level": this.level, "aria-disabled": this.disabled ? "true" : undefined, "aria-label": this.ariaLabelText }, h("div", { key: 'c6df99d7e12f26960f0778a3637077436adb6dde', class: "tree-item__content" }, h("div", { key: '4230745fde20cb34912ddec8df6e372ecf731295', class: "tree-item__checkbox-container", onClick: (e) => e.stopPropagation() }, h("ifx-checkbox", { key: 'f2427fd080cf584e108baab0d4191c00f31e3017', size: "s", checked: this.partialChecked ? false : this.isChecked, indeterminate: this.partialChecked, onIfxChange: this.handleCheckboxChange, disabled: this.disabled })), h("div", { key: 'f5df3195f0240df65be76aa39582006b374a7695', class: "tree-item__header", style: { paddingLeft: `${this.level * 24 + 10}px` }, onClick: this.handleHeaderClick, tabIndex: -1, "aria-disabled": this.disabled ? "true" : undefined }, this.hasChildren && (h("div", { key: '26c03bceeab66598c9e3b4a1d051562396aa3f67', class: "tree-item__chevron-container", onClick: this.toggleExpand }, h("ifx-icon", { key: '3836505855e92d8c14a4498f4e92ef31c1317456', class: `tree-item__chevron ${this.isExpanded ? "chevron-down" : "chevron-right"}`, icon: "chevron-right-16" }), h("div", { key: '6bbd7c85d57cc87e4d5045e520fd76cf4289f9a3', class: "tree-item__line" }))), h("div", { key: '880a55749a25cf992784f3e766776567bf401221', class: "tree-item__label-icon-container", tabIndex: this.disabled ? -1 : 0, onKeyDown: this.handleKeyDown }, h("div", { key: '5ef162fb074e4aca3fc1b63f124bf4d25c1b70df', class: "tree-item__icon-container" }, this.hasChildren ? (h(Fragment, null, h("ifx-icon", { class: { "icon--hidden": this.isExpanded }, icon: "folder-16" }), h("ifx-icon", { class: { "icon--hidden": !this.isExpanded }, icon: "folder-open-16" }))) : (h("ifx-icon", { icon: "file-16" }))), h("span", { key: '8a2983b5549be6b064ca43487e82e5b1ce87b3f0', class: "tree-item__label" }, h("slot", { key: 'fed0111daddee139a0c61b309cc5bd2565026219' }))))), this.isExpanded && (h("div", { key: '68363d440ec23381ffe6c60ff66d1bf84fab3b44', class: "tree-item__children" }, h("slot", { key: '42a6eefc0b750a946b28870eb1adb10cfdb3582d', name: "children" })))));
    }
